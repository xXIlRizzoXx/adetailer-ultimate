...
- **Interrupting a pass could save a half-finished region.** With two or more detections, pressing Interrupt or Skip while a region was being inpainted kept that half-denoised region in the final image, and a standalone or folder run saved it as detailed. The cancelled pass is now discarded, as it was before this beta.
