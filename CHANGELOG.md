...
- Add focused regression coverage, MediaPipe face-features and platform-guard tests, and a Windows unit-test job. Trigger checks for all Python changes, the front-end scripts, the stylesheet, the README and dependency configuration, including pushes to main. Mark model-download tests separately and bound test-image HTTP requests.
